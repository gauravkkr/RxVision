...
export const benefits = [
  ...
  {
    id: "1",
    title: "Medicine Name Recognition",
    text: "Automatically detect and return medicine names from prescription images using advanced OCR and medicine database matching.",
  ...
  {
    id: "2",
    title: "Accurate Medicine Matching",
    text: "Match detected text to exact medicine names from comprehensive database using prefix matching and fuzzy search algorithms.",
  ...
  {
    id: "3",
    title: "Clean Medicine Output",
    text: "Display only the matched medicine name as output, no raw extracted text or unnecessary information for clean, professional results.",
